...
[v1.2.0 software release](https://github.com/AvilaLabs/ACTINV/releases/tag/v1.2.0) ·
...
[v1.2.0 GitHub Release](https://github.com/AvilaLabs/ACTINV/releases/tag/v1.2.0).
...
desktop preview installers and application bundles are prepared separately from the published v1.2.0 release. PyPI and
