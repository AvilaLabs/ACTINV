...
[v1.2.1 software release](https://github.com/AvilaLabs/ACTINV/releases/tag/v1.2.1) ·
...
[v1.2.1 GitHub Release](https://github.com/AvilaLabs/ACTINV/releases/tag/v1.2.1).
...
desktop preview installers and application bundles are prepared separately from the published v1.2.1 release. PyPI and
