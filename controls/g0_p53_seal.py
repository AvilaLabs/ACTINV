#!/usr/bin/env python3
"""P53 G0 seal — binds protocol sha, opening commit, and every frozen
artifact hash. Emits results/g0_p53_seals.json. Evidence collected
...
OUT = ROOT / "results/g0_p53_seals.json"
ENVELOPE_S = 3600
