#!/usr/bin/env python3
"""P55 G0 seal — binds protocol sha, opening commit, and every frozen
artifact hash. Emits results/g0_p55_seals.json. Evidence collected
...
import p55_artifacts as p55a  # noqa: E402

OUT = ROOT / "results/g0_p55_seals.json"
