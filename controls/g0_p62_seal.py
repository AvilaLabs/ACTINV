#!/usr/bin/env python3
"""P62 G0 seal — binds protocol sha, opening commit, and every frozen
artifact hash. Emits results/g0_p62_seals.json. Evidence collected
...
import p62_artifacts as p62a  # noqa: E402

OUT = ROOT / "results/g0_p62_seals.json"
