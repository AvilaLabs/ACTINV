#!/usr/bin/env python3
"""P60 G0 seal — binds protocol sha, opening commit, and every frozen
artifact hash. Emits results/g0_p60_seals.json. Evidence collected
...
import p60_artifacts as p60a  # noqa: E402

OUT = ROOT / "results/g0_p60_seals.json"
