#!/usr/bin/env python3
"""P58 G0 seal — binds protocol sha, opening commit, and every frozen
artifact hash. Emits results/g0_p58_seals.json. Evidence collected
...
import p58_artifacts as p58a  # noqa: E402

OUT = ROOT / "results/g0_p58_seals.json"
