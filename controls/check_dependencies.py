...
CI_ENTRY = ["scripts/desktop_smoke.py", "scripts/package_desktop.py", "scripts/verify_desktop_package.py", "controls/test_p16_dependency_history.py", "controls/check_desktop.py", "controls/g0_cram_coefficients.py", "controls/gen_cram.py", "controls/check_release_notes.py",
