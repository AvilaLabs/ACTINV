#!/usr/bin/env python3
"""P57 G0 seal — binds protocol sha, opening commit, and every frozen
artifact hash. Emits results/g0_p57_seals.json. Evidence collected
...
import p57_artifacts as p57a  # noqa: E402

OUT = ROOT / "results/g0_p57_seals.json"
