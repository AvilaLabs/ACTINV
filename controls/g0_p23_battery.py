#!/usr/bin/env python3
"""P23 G0 producer: run the frozen identity battery at the parent commit.
...
RESULT = ROOT / "results/g0_p23_identity_baseline.json"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="actinv-p23-g0-") as directory:
        work = Path(directory)
        cache = work / "cache"
    ...
    evidence = {
        "schema": "actinv-p23-g0-baseline-1",
        "inputs": {
