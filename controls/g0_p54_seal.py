#!/usr/bin/env python3
"""P54 G0 seal — binds protocol sha, opening commit, and every frozen
artifact hash. Emits results/g0_p54_seals.json. Evidence collected
...
OUT = ROOT / "results/g0_p54_seals.json"
